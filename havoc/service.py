...
class HavocService:
    ...
    def __init__(self, endpoint: str, password: str):
        ...
        Thread(target=self.Socket.run_forever,
               kwargs={'sslopt': {'check_hostname': False, "cert_reqs": ssl.CERT_NONE}}).start()
                    ...
                    case "AgentTask":
                        ...
                        if data["Body"]["Task"] == "Get":
                            ...
                            data["Body"]["Command"] = base64.b64encode(
                                self.RegisteredAgent.task_prepare(data['Body']['Command'])).decode('utf-8')
